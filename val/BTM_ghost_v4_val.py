...
log_dir = r'../runs/model_log/BTM_ghost_net_v4'
model_save_dir = "../runs/model_pth/BTM_ghost_net_v4/"
...
if __name__ == '__main__':
    ...
    net.load_weights(os.path.join(model_save_dir, f"checkpoint_epoch_1160.pth"))
