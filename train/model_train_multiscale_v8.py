...
from model.sub_block.loss_cal import DynamicLoss
...
log_dir = r'/home/code/radio_map_construction/runs/model_log/BTM_multi_scale_v7_ssim'
model_save_dir = "/home/code/radio_map_construction/runs/model_pth/BTM_multi_scale_v7_ssim/"
...
def train(model, train_loader, val_loader, num_epochs, device, save_interval=5):
    ...
    for epoch in range(num_epochs):
        ...
        for inputs, targets, samples in train_loader:
            ...
            outputs = model(inputs)
            # Calculate loss
            loss = dynamic_loss(outputs, targets, epoch)
