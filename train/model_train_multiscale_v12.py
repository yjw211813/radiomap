...
from model.sub_block.loss_cal import DynamicLoss,FourierLoss,MaskFourierLoss,WaveletLoss
...
log_dir = r'/home/code/radio_map_construction/runs/model_log/BTM_multi_scale_v11_ssim'
model_load_dir = "/home/code/radio_map_construction/runs/model_pth/BTM_multi_scale_v6_ssim/"
model_save_dir = "/home/code/radio_map_construction/runs/model_pth/BTM_multi_scale_v11_ssim/"
...
def train(model, train_loader, val_loader, num_epochs, device, save_interval=5):
    ...
    waveletLoss = WaveletLoss(
        mse_weight=0.75,
        wavelet_amp_weight=0.2,
        wavelet_phase_weight=0.05,
        switch_epoch=5,
        mix_prob=1,
        wavelet='db1',
        levels=3
    ...
    for epoch in range(num_epochs):
        ...
        for inputs, targets, samples in train_loader:
            ...
            outputs = model(inputs)
            # Calculate loss
            loss = waveletLoss(outputs, targets, epoch)
