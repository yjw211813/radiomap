...
def SAUnet_test():
    ...
    model = SAUnet_old(BTM_ghost_UNet_input_shape, BTM_ghost_UNet_output_shape,C_down_list,attn_params).to(device)
    x = input_data
