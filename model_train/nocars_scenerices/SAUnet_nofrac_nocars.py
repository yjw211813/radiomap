...
if __name__ == '__main__':
    ...
    log_dir = base_dir + r'model_log/SAUnet_nofrac_nocars/'# log 存储位置
    model_load_dir = base_dir + r"model_pth/SAUnet_nofrac_nocars/"# 模型加载目录
    model_save_dir = base_dir + r"model_pth/SAUnet_nofrac_nocars/"# 模型存储位置
    ...
    load_epoch = 0
    val_dir = r"/home/code/radioMap/runs/model_val_log/SAUnet_nofrac_nocars/"
