...
if __name__ == '__main__':
    ...
    model_load_dir = base_dir + r"model_pth/old_SAUnetNoMultiScale/"# 模型加载目录
    model_save_dir = base_dir + r"model_pth/old_SAUnetNoMultiScale/"# 模型存储位置
    ...
    model = SAUnetNoMultiScale(BTM_ghost_UNet_input_shape, BTM_ghost_UNet_output_shape,C_down_list,attn_params)
    ...
    load_epoch = 0
    val_dir = base_dir + r"model_val_log/old_SAUnetNoMultiScale/"
