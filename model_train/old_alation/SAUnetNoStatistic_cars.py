...
if __name__ == '__main__':
    ...
    log_dir = base_dir + r'model_log/SAUnetNoSatistic_old_cars/'# log 存储位置
    model_load_dir = base_dir + r"model_pth/SAUnetNoSatistic_old_cars/"# 模型加载目录
    model_save_dir = base_dir + r"model_pth/SAUnetNoSatistic_old_cars/"# 模型存储位置
    ...
    model = SAUnet_old(input_shape = input_shape,output_shape= output_shape,
    ...
    load_epoch = 0
    val_dir = base_dir + r"model_val_log/SAUnetNoSatistic_old_cars/"
